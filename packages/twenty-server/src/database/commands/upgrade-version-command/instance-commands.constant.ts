...
import { CreateWorkspaceCapabilityCoreTableFastInstanceCommand } from 'src/database/commands/upgrade-version-command/2-30/2-30-instance-command-fast-1786301209072-create-workspace-capability-core-table';
...
export const INSTANCE_COMMANDS = [
  ...
  CreateWorkspaceCapabilityCoreTableFastInstanceCommand,
];
