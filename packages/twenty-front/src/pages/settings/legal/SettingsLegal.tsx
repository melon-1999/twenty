      ...
      <SettingsPageContainer>
        ...
        <Section>
          <H2Title
            ...
            description={t`This product (version ${PRODUCT_VERSION}) includes open-source components licensed under AGPL-3.0 and MIT. The complete corresponding source code of this version is available for download.`}
          />
          <StyledCardLink
